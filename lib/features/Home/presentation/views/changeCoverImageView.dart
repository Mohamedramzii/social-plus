...
class ChangeCoverImageView extends StatelessWidget {
  const ChangeCoverImageView({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<HomeCubit, HomeState>(
      listener: (context, state) {
        if (state is UploadingCoverImageSuccessState) {
                            ...
                            onPressed: () {
                              AwesomeDialog(
                                ...
                                btnOkOnPress: () {
                                  // isExitProfile=false;
                                  isExit = false;
                                  homecubit.getCoverImage(ImageSource.gallery);
                                },
                                btnOkText: 'Gallery',
                                ...
                                btnCancelOnPress: () {
                                  // isExitProfile=false;
                                  isExit = false;
                                  homecubit.getCoverImage(ImageSource.camera);
                                },
